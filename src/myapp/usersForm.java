...
public class usersForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jl6.setText("label");
        jPanel3.add(jl6);
        jl6.setBounds(50, 0, 110, 40);

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 300, 210, 40));
        ...
        exitPane.setBackground(new java.awt.Color(0, 204, 204));
    ...
    private void jPanel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel3MouseClicked
        ...
        db_configuration dbc = new db_configuration();
        dbc.insertData("INSERT INTO users_tbl( u_lname,u_fname,u_bdate, u_user, u_pword, u_email)"
        ...
        db_configuration dbc = new db_configuration();
        dbc.updateData("UPDATE users_tbl"
